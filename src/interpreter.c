...
static void init_keywords() {
    ...
    add_keyword("not", kw_not, 1, 3);

    add_keyword("equal", kw_equal, 2, 3);
    add_keyword("greater", kw_greater, 2, 3);
    add_keyword("less", kw_less, 2, 3);
    ...
    add_keyword("if", kw_if, 1, 0);
    add_keyword("elif", kw_if, 1, 0);
    add_keyword("else", kw_else, 0, 0);
